...
class roomEntry:
    def __init__(self, surface, host, maps, players, y):
        ...
        box1 = hostText.get_rect()
        box1.center = pygame.Rect(70,y,220,50).center
        
        box2 = mapText.get_rect()
        box2.center = pygame.Rect(290,y,220,50).center
        
        box3 = playersText.get_rect()
        box3.center = pygame.Rect(510,y,220,50).center

        surface.blit(hostText, box1)
        surface.blit(mapText, box2)
        surface.blit(playersText, box3)
