...
class roomEntry:
    ...
    def __init__(self, surface, room, y, touching = False):
        
        #Only render if within dimenions
        if y >= 100 and y < 560:
                
            #Set colour based on if touching
            if touching == False:
                colour = (220,220,220)
            else:
                colour = (220,220,0)
            ...
            idText = font.render(str(self.ID), True, colour)
            hostText = font.render(HOST, True, colour)
            mapText = font.render(MAP, True, colour)
            playersText = font.render(PLAYERS+"/4", True, colour)
            ...
            pygame.draw.line(surface, colour, (70,y+50), (730,y+50), 1)
